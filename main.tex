...
\newcommand*{\getTitle}{Dynamic Hybrid Position/Force Control for Hybrid Obstacle Aided Locomotion in Snake Robots}
...
\newcommand*{\getSubmissionDate}{June 1, 2020}
...
%\afterpage{\null\newpage}
\includepdf{pages/oppgtekst_master.pdf}
%\afterpage{\null\newpage}
...
\input{chapters/modelspecs}
\input{chapters/3 - Theory/03_Theory.tex}
\input{chapters/4 - Simulator/04_Simulator}
\input{chapters/6 - Experiments/06_results}
